...
_Avoid_: Key type, scope prefix (this project decided against encoding authorization-relevant type/scope in the key string — see [ADR 0008](./docs/adr/0008-api-key-prefix-is-cosmetic-only.md)).
